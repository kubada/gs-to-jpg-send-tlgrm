...
poppler = r'C:\Users\Violet\PycharmProjects\gs-to-jpg-send-tlgrm
\poppler\bin'
save_folder = r'C:\Users\Violet\PycharmProjects\gs-to-jpg-send-tlgrm
\files'
...
def main(gid):
    ...
    with open(r'files\test-table.pdf', 'wb') as out_file:
        for chunk in response:
            out_file.write(chunk)

    # Google Spreadsheet pdf to jpg
    convert_from_path(r'files\test-table.pdf', poppler_path=poppler, output_folder=save_folder,
    ...
    requests.post('https://api.telegram.org/bot' + bot + '/sendPhoto',
                  files={'photo': open(r'files\test-table0001-1.jpg', 'rb')},
...
os.remove(r'files\test-table.pdf')
os.remove(r'files\test-table0001-1.jpg')
